...
contract PixelArtGrayscaleNFT is ERC721, ERC721Enumerable, ERC721URIStorage {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() ERC721("PixelArtGrayscaleNFT", "PixelArtGrayscaleNFT") {}
        ...
        returns (string memory)
    {
        bytes memory dataURI = abi.encodePacked(
            "{",
            '"name": "PixelArtGrayscaleNFT",',
            '"description": "PixelArtGrayscaleNFT With three colors as gray,black and white",',
            '"image": "',
