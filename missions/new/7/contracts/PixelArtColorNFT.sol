...
contract PixelArtColorNFT is ERC721, ERC721Enumerable, ERC721URIStorage {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() ERC721("PixelArtColorNFT", "PixelArtColorNFT") {}
        ...
        returns (string memory)
    {
        bytes memory dataURI = abi.encodePacked(
            "{",
            '"name": "PixelArtColorNFT",',
            '"description": "PixelArtGrayscaleNFT With rgb colors",',
            '"image": "',
